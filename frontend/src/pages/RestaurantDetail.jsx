              ...
              <Stack spacing={2}>
                <Box sx={{ 
                  ...
                  <Typography variant="body1" sx={{ fontWeight: 500 }}>
                    Description: <span style={{ color: '#666' }}>{restaurant.description ? restaurant.description : "No Description"  }</span>
                  </Typography>
                </Box>
                ...
                <Box sx={{ 
                  ...
                  <Typography variant="body1" sx={{ fontWeight: 500 }}>
                    Address: <span style={{ color: '#666' }}>{restaurant.address}</span>
                  </Typography>
                </Box>
                <Box sx={{ 
                  display: 'flex', 
                  ...
                  <Typography variant="body1" sx={{ fontWeight: 500 }}>
                    Locality: <span style={{ color: '#666' }}>{restaurant.locality}</span>
                  </Typography>
                </Box>
                <Box sx={{ 
                  display: 'flex', 
                  ...
                  <Typography variant="body1" sx={{ fontWeight: 500 }}>
                    City: <span style={{ color: '#666' }}>{restaurant.city}</span>
                  </Typography>
                </Box>
                <Box sx={{ 
                  display: 'flex', 
                  ...
                  <CurrencyExchangeIcon sx={{ mr: 1.5, color: 'primary.main' }} />
                  <Typography variant="body1" sx={{ fontWeight: 500 }}>
                    Average Cost for Two: <span style={{ color: '#666' }}>{restaurant.
averageCostForTwo
} {restaurant.currency}</span>
                  </Typography>
                </Box>
                <Box sx={{ 
                  display: 'flex', 
                  ...
                  <Typography variant="body1" sx={{ fontWeight: 500 }}>
                    Price Range: <span style={{ color: '#666' }}>{'$'.repeat(restaurant.priceRange
)}</span>
                  </Typography>
                </Box>
                <Box sx={{ 
                  ...
                  <Typography variant="body1" sx={{ fontWeight: 500 }}>
                    Table Booking: <span style={{ color: '#666' }}>{restaurant.hasTableBooking ? 'Available' : 'Not Available'}</span>
                  </Typography>
                </Box>
                <Box sx={{ 
                  display: 'flex', 
                  ...
                  <Typography variant="body1" sx={{ fontWeight: 500 }}>
                    Online Delivery: <span style={{ color: '#666' }}>{restaurant.hasOnlineDelivery ? 'Available' : 'Not Available'}</span>
                  </Typography>
                </Box>
              </Stack>
            </Paper>
